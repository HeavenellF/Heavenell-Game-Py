...
def level3_object(width, height):
    ...
    level3_object.append((platform1_surf, platform1_rect))
    ...
    level3_object.append((platform2_surf, platform2_rect))
    ...
    level3_object.append((platform3_surf, platform3_rect))

    platform4_surf = pygame.image.load('image/level/level3/Platform4.png').convert_alpha()
    platform4_rect = platform4_surf.get_rect(topleft=(371, 612))
    level3_object.append((platform4_surf, platform4_rect))

    platform5_surf = pygame.image.load('image/level/level3/Platform5.png').convert_alpha()
    platform5_rect = platform4_surf.get_rect(topleft=(371, 362))
    level3_object.append((platform5_surf, platform5_rect))

    platform6_surf = pygame.image.load('image/level/level3/Platform6.png').convert_alpha()
    platform6_rect = platform6_surf.get_rect(topleft=(371, 112))
    level3_object.append((platform6_surf, platform6_rect))
